    ...
    <div className="SubmitPage">
      ...
      <div className="section" id="section-5">
        <div className='container'>
          ...
          <p>The D4SD Jam Sessions are free, online, public events. In case you cannot join the live sessions on Fridays, the videos from each session will be recorded and posted <a href='https://www.youtube.com/playlist?reload=9&list=PLoWuaQlGD1dnl3-oFWyssQoUZZHOH1t9u' target='_blank' rel="noopener noreferrer">here on Youtube</a>. The slides for the plenary sessions are also posted below.</p>
          <div className="gslides">
            ...
            <div id='prototype'>
              <h4 className='subtitle'>Jam #3 on PROTOTYPE (April 24)</h4>
              <ReactGoogleSlides
                width='100%'
                height={400}
