...
import { Row, Col, Collapse, Button, Timeline, Icon } from "@d4sd/components";
...
const WorkspaceLayout = (props: any) => {
  return (
    <div>
      <Header title={workspaceContent.title1} content={workspaceContent.content1} image={workspaceContent.image}/>
