...
import {Form, Input, Card, Button, Radio } from '@d4sd/components';
import './style.less';
    ...
    <Card className="card-signup-choice">
      ...
      <Radio.Group onChange={onChange} value={value}>
        <div className="choice">
          <Radio value="participant"/><label className="choice-label">Participant</label>
            <p>
            As an innovator, you are able to meet new people and tackle SD’s problems with a team of like-minded individuals.
            </p>
          </div>
        <div className="choice">
          <Radio value="feedback"/><label className="choice-label">Feedback provider</label>
            <p>
