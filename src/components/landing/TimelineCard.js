...
import {
  Card, OuterFlexBox, InnerFlexBox, OuterContainer, InnerContainer, FlexibleWidth, StyledCarouselProvider,
          ...
          <FAQBtn onClick={this.toggleContent} style={{ padding: '0' }}>
            <Card theme={{ paddingS: '10px', paddingM: '20px 10px', paddingL: '30px 50px 30px 30px' }}>
              <InnerFlexBox center>
                ...
                {this.state.open ? <i className="fas fa-chevron-up" style={{ color: 'rgba(0, 0, 0, 0.5)' }} /> : <i className="fas fa-chevron-down" style={{ color: 'rgba(0, 0, 0, 0.5)' }} />}
              </InnerFlexBox>
