...
const HowItWorksCard = (props: any) => (
  <div className="HowItWorksCard">
    ...
    <p>Here is your team’s opportunity to get feedback from members of the San Diego community on your preliminary concepts!   One (and only one) team member should prepare a submission with the following information. You can can save changes at anytime and return to work on it up until the community feedback deadline. </p>
        ...
        <p>Finally, after you review and submit your preliminary submission, you will not be able to make further edits.  You will be given a team project URL that you can share and get feedback from friends and colleagues.
</p>
    </div>
    <div className="bottom-btn">
      <Button className="d4sd-btn" block type="primary" size="large" htmlType="submit" onClick={() => props.setSubmitStep('projectInfo')}>START SUBMISSION</Button>
    </div>
  </div>
);
